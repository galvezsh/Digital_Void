export default {
    ...
    error400Label: "<p>Looks like you're playing around with the URL. What are you up to?</p><p>Don't try to find backdoors — there aren't any.</p><p>You'd better return to the <a href='/'>home page</a>.</p>",
    error401Title: "Unauthorized",
    error401Label: "<p>Looks like you can't access this site. What are you up to?</p><p>Don't try to find backdoors — there aren't any.</p><p>You'd better return to the <a href='/'>home page</a>.</p>",
    error403Title: "Access Denied",
    error403Label: "<p>Looks like you're trying to access something you shouldn't.</p><p>Don't try to find backdoors — there aren't any.</p><p>You'd better return to the <a href='/'>home page</a>.</p>",
    error404Title: "Page Not Found",
    error404Label: "<p>There's nothing here for you.</p><p>Don't try to find backdoors — there aren't any.</p><p>You'd better return to the <a href='/'>home page</a>.</p>",

    error500Title: "Internal Error",
    error500Label: "<p>An unknown error has occurred. Was it you?</p><p>Don't try to find backdoors — there aren't any.</p><p>You'd better return to the <a href='/'>home page</a>.</p>",
    error502Title: "Bad Gateway",
    error502Label: "<p>The gateway isn't working correctly. Was it you?</p><p>Don't try to find backdoors — there aren't any.</p><p>You'd better return to the <a href='/'>home page</a>.</p>",
